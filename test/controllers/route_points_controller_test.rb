...
class RoutePointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create route_point" do
    assert_difference('RoutePoint.count') do
      post route_points_url, params: { route_point: { description: @route_point.description, number: @route_point.number } }
    end
  ...
  test "should update route_point" do
    patch route_point_url(@route_point), params: { route_point: { description: @route_point.description, number: @route_point.number } }
